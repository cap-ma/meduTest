    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_profile', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='user.studentprofile')),
                ('teacher_profile', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='user.teacherprofile')),
