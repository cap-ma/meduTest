# Generated by Django 4.2.1 on 2023-07-01 12:00
    ...
    operations = [
                    ...
                    models.CharField(
                        ...
                        validators=[
                            django.core.validators.RegexValidator(
                                message="must be in this format: +998999999999 ",
                                regex="^\\+?1?\\d{9,13}$",
                            )
                        ],
                    ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.DO_NOTHING, to="user.teacherprofile"
            ),
        ),
        migrations.CreateModel(
            name="Student",
